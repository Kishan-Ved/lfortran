...
class ASRBuilder {
    ...
    #define tMul(left, right, t) EXPR(ASR::make_IntegerBinOp_t(al, loc,             \
            left, ASR::binopType::Mul, right, t, nullptr))    
...
namespace Shiftl {
    ...
    static inline ASR::expr_t* instantiate_Shiftl(Allocator &al, const Location &loc,
        ...
        */
        ASR::expr_t *two = i(2, arg_types[0]);
        body.push_back(al, b.Assignment(result, tMul(args[0], iPow(two, args[1], arg_types[0]), arg_types[0])));
